...
missing values with NA are in rows 346 and 347, but there are a lot more 0 which are mostly not missing at random (MAR), but some times they do, 
later we will replace the 0 with NA, but for investigation not drop or impute them
